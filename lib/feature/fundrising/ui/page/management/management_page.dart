...
class ManagementPage extends ConsumerStatefulWidget {
  const ManagementPage({super.key, this.params});

  final ManagementParams? params;
...
class _ManagementPageState extends ConsumerState<ManagementPage> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      unawaited(
          ref.read(managementControllerProvider.notifier).init(widget.params));
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    Future<bool> onBack() async {
      context.pop(ManagementResult(
        managers: state.users,
        managersTreshold: state.treshold,
      ));
      return true;
    }
              ...
              child: Padding(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    TribeInputButton(
                        ...
                        onPressed: () async {
                          final user = await context
                              .pushNamed<User?>(UserListContract.name);
                          if (user != null) {
                    ...
                    Text(
                      context
                          .localisation.managementSignatureTresholdDescription,
                      style: context.textStyles.body,
                    ),
                    TribeSpaceVertical.double(),
                    TribeMajoritySplitter(
                      current: state.treshold,
