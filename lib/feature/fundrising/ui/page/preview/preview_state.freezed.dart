...
class _$_PreviewState implements _PreviewState {
  const _$_PreviewState();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$_PreviewState);
  }
...
abstract class _PreviewState implements PreviewState {
  const factory _PreviewState() = _$_PreviewState;
}
