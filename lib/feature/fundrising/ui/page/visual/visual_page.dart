...
class _VisualPageState extends ConsumerState<VisualPage> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(visualControllerProvider.notifier).init();
    });
    super.initState();
  }
                ...
                children: [
                  ...
                  TribeVisual(
                    ...
                    onShufflePressed: () {
                      ...
                      final emoji = emojies[random.nextInt(emojies.length - 1)];
                        ...
                        if (pickedFile != null && context.mounted) {
                          final croppedFile = await ImageCropper().cropImage(
                            ...
                            uiSettings: [
                              ...
                              IOSUiSettings(
                                title: context.localisation.visualMoveAndScale,
                              ),
                            ],
                          );
                  ...
                  TribeButton(
                    ...
                    onPressed: () async {
                      ...
                      final params = state.visualType.map(
                        emoji: (emoji) => EmojiParams(emoji.emoji, state.color),
                        image: (_) => null,
                      );
